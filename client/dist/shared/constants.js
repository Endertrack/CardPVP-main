import { CostType, BuffType } from './types';
// ===== 游戏常量 =====
...
export function parseIcon(iconStr) {
...
// 便捷创建 EffectDef
function eff(buffType, value, duration) {
    return { buffType, value, duration, target: 'self' };
}
// 便捷创建 ActiveBuff
function activeBuff(buffType, stacks, remainingTurns) {
    const value = stacks;
