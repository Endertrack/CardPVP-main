...
export default function Lobby() {
    ...
    return (_jsxs("div", { className: "min-h-screen flex items-center justify-center p-6", children: [isLandscape ? (_jsxs("div", { className: "flex items-center justify-center gap-16 w-full max-w-3xl", children: [LogoBlock, ButtonBlock] })) : (_jsxs("div", { className: "flex flex-col items-center justify-center gap-10 w-full", children: [LogoBlock, ButtonBlock] })), showCollection && (_jsx(CollectionModal, { onClose: () => setShowCollection(false) })), showRules && (_jsx(RulesModal, { onClose: () => setShowRules(false) }))] }));
}
