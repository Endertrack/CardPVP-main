...
export default function Game() {
    ...
    useEffect(() => {
        ...
        if (!hasEnchantInHand || matchedCount < 4)
            shownEnchantReady.current = false;
