...
export default function WaitingRoom() {
    ...
    return (_jsx("div", { className: "min-h-screen flex items-center justify-center p-6", children: isLandscape ? (_jsxs("div", { className: "flex items-center justify-center gap-12 w-full max-w-4xl", children: [LeftBlock, RightBlock] })) : (_jsxs("div", { className: "flex flex-col items-center justify-center gap-6 w-full", children: [LeftBlock, RightBlock] })) }));
}
