...
export function CardCollectionContent() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3", children: cards.map(card => {
                    ...
                    return (_jsxs("div", { className: "bg-card-bg border border-card-border/60 rounded-xl p-3 flex flex-col items-center gap-2 hover:shadow-md transition-shadow", children: [_jsx("img", { src: `/assets/item/${imgNum}${imgExt}`, alt: card.name, className: "w-14 h-14 object-contain" }), _jsx("span", { className: "text-sm font-semibold text-text-primary text-center", children: card.name }), _jsx("span", { className: `px-2 py-0.5 rounded text-[9px] font-medium ${badgeCls}`, children: COST_TYPE_NAMES[card.costType] }), _jsxs("span", { className: "text-[8px] text-text-secondary/50", children: ["\u6743\u91CD ", card.weight] }), _jsx("div", { className: "w-full space-y-0.5", children: card.effects.map((eff, i) => {
                                    const buffName = BUFF_NAMES[eff.buffType];
                                    if (!buffName)
                                        return null;
                                    return (_jsxs("div", { className: "text-[10px] text-text-secondary leading-tight flex items-center gap-1", children: [_jsx("span", { className: "text-text-primary", children: "\u2022" }), _jsx("span", { children: buffName }), eff.value > 0 && _jsx("span", { className: "text-text-primary", children: eff.value }), eff.duration && _jsxs("span", { children: ["\uFF08", eff.duration, "\u56DE\u5408\uFF09"] })] }, i));
                                }) }), _jsx("span", { className: "text-[9px] text-text-secondary/70 text-center leading-tight", children: card.description })] }, card.id));
