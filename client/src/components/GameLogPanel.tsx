...
export default function GameLogPanel({ log, onClose }: Props) {
  ...
  return (
    <>
      ...
      {/* 面板主体 */}
      <div className="fixed right-0 top-0 h-full w-96 max-w-[90vw] bg-card-bg/95 backdrop-blur-xl border-l border-card-border/50 shadow-2xl z-[60] animate-slide-in-right flex flex-col rounded-l-2xl">
